...
/**
 * ----------------------------------------------------
 * Valid scenarios for command: make:scenario WebRoute
 * ----------------------------------------------------
 */
describe('Commands - make:scenario : success', function () use ($context): void {
    describe('WebRoute', function () use ($context): void {
        describe('missing arguments and/or options', function () use ($context): void {
            ...
            Scenario::forCommand()->valid(
                ...
                context: $context,
                // --- Arguments and options -------------------------------------------------
                arguments: 'WebRoute --route=web.dummies.index',
                // --- Command assertions ----------------------------------------------------
                commandAssertions: fn (PendingCommand $command) => $command
                    ->expectsQuestion(
                        question: 'What is your test file name ?',
            ...
            Scenario::forCommand()->valid(
                ...
                context: $context,
                // --- Arguments and options -------------------------------------------------
                arguments: 'WebRoute Feature/Test',
                // --- Command assertions ----------------------------------------------------
                commandAssertions: fn (PendingCommand $command) => $command
                    ->expectsQuestion(
                        question: 'Which route do you want to test ?',
        ...
        describe('command complete', function () use ($context): void {
            ...
            Scenario::forCommand()->valid(
                ...
                context: $context,
                // --- Arguments and options -------------------------------------------------
                arguments: 'WebRoute Feature/Test --route=web.dummies.index',
                // --- Command assertions ----------------------------------------------------
                commandAssertions: fn (PendingCommand $command) => $command
                    ->expectsOutput('Scenario test file created successfully.')
                    ->assertSuccessful()
            ...
            Scenario::forCommand()->valid(
                ...
                context: $context,
                // --- Arguments and options -------------------------------------------------
                arguments: 'WebRoute Feature/Test -R web.dummies.index',
                // --- Command assertions ----------------------------------------------------
                commandAssertions: fn (PendingCommand $command) => $command
                    ->expectsOutput('Scenario test file created successfully.')
                    ->assertSuccessful()
            ...
            Scenario::forCommand()->valid(
                ...
                context: $context,
                // --- Arguments and options -------------------------------------------------
                arguments: 'WebRoute Feature/Test -R web.dummies.index -A dummy:command',
                // --- Command assertions ----------------------------------------------------
                commandAssertions: fn (PendingCommand $command) => $command
                    ->expectsOutput('Scenario test file created successfully.')
                    ->assertSuccessful()
...
/**
 * ----------------------------------------------------
 * Invalid scenarios for command: make:scenario WebRoute
 * ----------------------------------------------------
 */
    ...
    describe('WebRoute', function () use ($context): void {
        describe('invalid arguments', function () use ($context): void {
            ...
            Scenario::forCommand()->invalid(
                ...
                context: $context->withMocks([]),
                // --- Arguments and options -------------------------------------------------
                arguments: 'WebRoute Inv@lid.filename --route=web.dummies.index',
                // --- Command assertions ----------------------------------------------------
                commandAssertions: fn (PendingCommand $command) => $command
        ...
        describe('invalid options', function () use ($context): void {
            ...
            Scenario::forCommand()->invalid(
                ...
                context: $context->withMocks([]),
                // --- Arguments and options -------------------------------------------------
                arguments: 'WebRoute Feature/Test --route=non.existing.route',
                // --- Command assertions ----------------------------------------------------
                commandAssertions: fn (PendingCommand $command) => $command
